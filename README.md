...
- <img src="https://fastify.dev/img/logos/fastify-white.svg" alt="Fastify" width="45"/> **Fastify** — Framework back-end focado em performance e baixo overhead.
...
- 🔥 **[Chat Funcional (Full-Stack)](https://github.com/Braian-de-Liz/chat-funcional)** Comunicação em tempo real utilizando WebSocket (`ws`) puro para troca de mensagens instantâneas.
...
- 📱 **WhatsApp:** [+55 (47) 93380-3828](https://wa.me/5547933803828)
